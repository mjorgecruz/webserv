...
SRC := main.cpp HttpRequest.cpp HttpResponse.cpp Server.cpp  Socket.cpp Http.cpp FileChecks.cpp Location.cpp InputHandler.cpp DeleteHandler.cpp CgiManagement.cpp utils.cpp SessionManagement.cpp
